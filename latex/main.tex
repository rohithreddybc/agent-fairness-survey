...
\emph{Takeaway:} AMPLIFY and GENERATE are the two genuinely agentic modes. Single-turn evaluation cannot exhibit either, and (as Table~\ref{tab:component-harm} and \S{}7 show) these are also the ones the field has instrumented least.
...
\subsection{Results: A Pilot Run}
...
\begin{table*}[htbp]
\centering\small
\caption{Pilot run results (Claude Haiku 4.5, temperature 0, 10 synthetic resume-screening profiles, single name-pair counterfactual): answer-level and decision-action disparity across configurations C0, C2, and C3.}
