...
\label{tab:2}
\resizebox{\columnwidth}{!}{%
\begin{tabular}{|p{0.113\textwidth}|p{0.113\textwidth}|p{0.113\textwidth}|p{0.113\textwidth}|p{0.113\textwidth}|p{0.113\textwidth}|p{0.113\textwidth}|p{0.113\textwidth}|}
\toprule
...
\paragraph{PRISMA Flow (Figure 0)}
...
\emph{Figure 0: PRISMA Flow Diagram} renders this four-stage funnel with counts at each node and branching reason labels. \emph{Takeaway: the corpus construction is transparent and reproducible; the 202 included papers represent systematic coverage rather than convenience selection.}
...
\label{tab:9}
\resizebox{\columnwidth}{!}{%
\begin{tabular}{|p{0.150\textwidth}|p{0.150\textwidth}|p{0.150\textwidth}|p{0.150\textwidth}|p{0.150\textwidth}|p{0.150\textwidth}|}
\toprule
...
This section projects the 202-paper corpus onto its two organizing axes simultaneously: the six agent-pipeline components and the four fairness dimensions (group, individual, counterfactual, and unspecified). The projection is Figure 2 (the coverage matrix) and its companion, Figure 3 (the locus $\times$ BCF-operator grid). Read together, they convert the survey's central claim (that the field is well-instrumented where measurement is easy and under-instrumented where agentic deployment makes fairness consequential) from an assertion into a structured, falsifiable coordinate.
...
\textbf{Figure 2: Coverage matrix (agent component $\times$ fairness dimension).}
...
\begin{tabular}{|p{0.180\textwidth}|p{0.180\textwidth}|p{0.180\textwidth}|p{0.180\textwidth}|p{0.180\textwidth}|}
\toprule
\textbf{Component} & \textbf{group} & \textbf{individual} & \textbf{counterfactual} & \textbf{unspecified} \\
\midrule
...
\subsubsection{Figure 3: Locus $\times$ BCF-Operator Grid}
...
\begin{tabular}{|p{0.150\textwidth}|p{0.150\textwidth}|p{0.150\textwidth}|p{0.150\textwidth}|p{0.150\textwidth}|p{0.150\textwidth}|}
\toprule
\textbf{Component \textbackslash\{\} Operator} & \textbf{ATTENUATE $\varphi$<1} & \textbf{PRESERVE $\varphi$$\approx$1} & \textbf{AMPLIFY $\varphi$>1} & \textbf{GENERATE $\varphi$ (zero$\rightarrow$nonzero)} & \textbf{Uncharacterized} \\
\midrule
...
\subsubsection{Empty Operator Rows of Figure 3: Governance and Standardized Auditing}
...
\item The conduction-operator tagging in Figure 3 reflects the survey authors' interpretation of whether each cited paper's finding instantiates ATTENUATE, PRESERVE, AMPLIFY, or GENERATE at the relevant locus, not a standardized classification applied by the original authors. Some cells may be reclassified as the audit methodology is refined.
