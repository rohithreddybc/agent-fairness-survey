...
This study is deliberately modest in scale and serves three purposes: a \textbf{constructive existence proof} that the P2 Masking gap is empirically measurable and present at this scale, paired with a direct test of P3 Super-additivity whose amplification prediction is not borne out at this scale; a \textbf{methodological template} (pinned models, synthetic counterfactuals, paired answer/action metrics, BCF-labeled configurations) portable across domains; and a \textbf{design seed} for the acting-agent benchmark called for in \S{}8.1. FairMedAgent, a forthcoming companion benchmark for clinical acting agents evaluated under matched demographic counterfactuals, is one scaled realization of this instrumentation; its development is independent of this survey's claims.
